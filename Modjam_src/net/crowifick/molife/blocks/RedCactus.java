...
public class RedCactus extends Block implements IPlantable {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon(Info.MODID + ":RedCactusSide");
		this.cactusTopIcon = par1IconRegister.registerIcon(Info.MODID + ":RedCactusTop");
		this.cactusBottomIcon = par1IconRegister.registerIcon(Info.MODID + ":RedCactusBottom");
	}
