...
public class BlueCactus extends Block implements IPlantable {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon(Info.MODID + ":BlueCactusSide");
		this.cactusTopIcon = par1IconRegister.registerIcon(Info.MODID + ":BlueCactusTop");
		this.cactusBottomIcon = par1IconRegister.registerIcon(Info.MODID + ":BlueCactusBottom");
	}
